(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    if(sub && location.pathname.startsWith('/territorio/') && !sub.querySelector('a[href="/territorio/migraciones/"]')){
