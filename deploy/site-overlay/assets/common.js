(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    if(sub && location.pathname.startsWith('/territorio/')){
      const debt=sub.querySelector('a[href="/territorio/endeudamiento/"]');
      let mig=sub.querySelector('a[href="/territorio/migraciones/"]');
      if(!sub.querySelector('a[href="/territorio/estructura-productiva/"]')){
        ...
        const before=mig||debt;before?sub.insertBefore(a,before):sub.appendChild(a);
      }
      mig=sub.querySelector('a[href="/territorio/migraciones/"]');
      if(!mig){const a=document.createElement('a');a.href='/territorio/migraciones/';a.textContent='Migraciones';debt?sub.insertBefore(a,debt):sub.appendChild(a)}
    }
    initSearch();
  });
  function initSearch(){
