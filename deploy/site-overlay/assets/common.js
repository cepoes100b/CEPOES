  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    if(sub&&location.pathname.startsWith('/territorio/')){
      if(!sub.querySelector('a[href="/territorio/estructura-productiva/"]')){
        ...
        const mig=sub.querySelector('a[href="/territorio/migraciones/"]'),debt=sub.querySelector('a[href="/territorio/endeudamiento/"]');
        mig?sub.insertBefore(a,mig):debt?sub.insertBefore(a,debt):sub.appendChild(a);
      }
