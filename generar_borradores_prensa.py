...
def main():
    ...
    raw = [
      {"slug":f"migraciones-comuna-{mvals[0][1]}-{mig['latest']['place_birth_commune_eah']}","topic":"Trabajo e ingresos","tags":["Migraciones",f"Comuna {mvals[0][1]}"],"title":f"La Comuna {mvals[0][1]} encabeza el peso de la migración internacional","summary":f"La EAH {mig['latest']['place_birth_commune_eah']} estima que el {mvals[0][0]:.1f}% de su población nació en otro país.","body":["La distribución territorial de la población migrante internacional presenta diferencias marcadas entre comunas. Este borrador identifica el valor máximo del último período disponible y queda sujeto a revisión editorial."],"methodology":"Encuesta Anual de Hogares de IDECBA. Las estimaciones comunales están sujetas a error muestral.","source_label":"IDECBA · Elaboración CEPOES","source_section":"/territorio/migraciones/","source_period":str(mig['latest']['place_birth_commune_eah'])},
      {"slug":f"acceso-clubes-{sport['generado']}","topic":"Salud y cuidados","tags":["Deporte y salud","Clubes de barrio","Accesibilidad"],"title":f"Más de {cov['poblacion_fuera_cobertura_estimada']:,.0f} porteños quedan a más de 800 metros caminables de un club".replace(",","."),"summary":f"La cobertura peatonal estimada alcanza al {cov['cobertura_pct']:.1f}% de la población.","body":["La medición sobre la red peatonal permite observar brechas que la distancia en línea recta no registra. El resultado no equivale a acceso efectivo y debe interpretarse junto con las limitaciones metodológicas."],"methodology":"Radios censales 2022 y recorridos estimados sobre OpenStreetMap.","source_label":"BA Data, INDEC y OpenStreetMap · Elaboración CEPOES","source_section":"/territorio/deporte-salud/","source_period":sport['generado']},
      {"slug":f"empresas-registradas-{series[-1]['anio']}","topic":"Producción y comercio","tags":["Estructura productiva","Empresas","Empleo registrado"],"title":f"CABA registra {series[-1]['empresas']:,} empresas privadas con empleo asalariado".replace(",","."),"summary":f"Son {series[0]['empresas']-series[-1]['empresas']:,} menos que en {series[0]['anio']}.".replace(",","."),"body":["La serie permite comparar la evolución del stock de empresas privadas registradas en la Ciudad. No debe confundirse con cantidad de locales ni con el universo de trabajadores independientes."],"methodology":"Empresas privadas con empleo asalariado registrado según OEDE/SIPA.","source_label":"OEDE/SIPA · Elaboración CEPOES","source_section":"/territorio/estructura-productiva/","source_period":str(series[-1]['anio'])},
      {"slug":f"mora-maxima-{debt['periodo']}","topic":"Precios y consumo","tags":["Endeudamiento","Mora","Barrios"],"title":f"{mora[0][1]} presenta la mayor incidencia barrial estimada de mora","summary":f"La proporción alcanza al {mora[0][0]:.1f}% de las personas deudoras en {debt['periodo']}.","body":["La estimación territorial muestra una distribución desigual de la mora entre barrios. Los resultados son agregados estadísticos y no geolocalizaciones individuales."],"methodology":"Central de Deudores del BCRA y Padrón ARCA; matriz postal-territorial de CEPOES.","source_label":"BCRA y Padrón ARCA · Elaboración CEPOES","source_section":"/territorio/endeudamiento/","source_period":debt['periodo']}
    ]
    for d in raw:
