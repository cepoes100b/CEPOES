...
EDUCATION = {
    ...
    "index": ["Síntesis", "Lo que dice PISA", "Evaluaciones porteñas", "Cómo pueden ser ciertas", "Contexto y límites", "Propuestas y fuentes"],
...
EDU_SECTIONS = [
    ...
    {"title": "El contexto presupuestario y los límites del dato", "items": [
        ...
        ("p", "Lo que el dato no permite decir", "report"),
        ("bullet", "PISA es muestral; FEPBA y TESBA son censales. No son el mismo instrumento ni miden exactamente la misma población. La comparación entre ambos es legítima como señal de alerta, no como medición."),
        ("bullet", "Los puntajes de Lengua y Matemática están en escalas distintas y no son comparables entre sí. Cualquier afirmación del tipo \"en tal comuna conviene priorizar Matemática\" exige comparar cada comuna contra el promedio de la Ciudad dentro de la misma materia, o usar el porcentaje por debajo del nivel básico, que sí es una métrica de incidencia comparable entre áreas."),
        ("bullet", "PISA no admite corte por comuna. Da jurisdicción. El corte territorial sale exclusivamente de FEPBA y TESBA."),
        ("bullet", "La unidad de esos datos es la comuna de la escuela, no la de residencia. Atribuir a los vecinos de una comuna el desempeño de las escuelas que están en ella es una falacia ecológica."),
        ("bullet", "Dos fotos no son una trayectoria. FEPBA y TESBA miden 7° grado y 3° año. Lo que pasa en el medio - repitencia, sobreedad, materias adeudadas - no se publica a ningún nivel."),
    ]},
...
PLATFORMS = {
    ...
    "scope": "Ciudad de Buenos Aires",
    "index": ["Síntesis", "Cuánta gente", "Cruce con juventudes", "Norma y riesgo", "Propuestas", "Límites y fuentes"],
...
PLAT_SECTIONS = [
    ...
    {"title": "Lo que este informe no afirma y fuentes", "items": [
        ("bullet", "No afirma cuántos trabajadores de plataformas hay en la Ciudad, porque ese dato no existe."),
        ("bullet", "No afirma que el cuentapropismo porteño mida trabajo de plataformas: lo usa como proxy y lo declara."),
        ("bullet", "No atribuye a la Ciudad de Buenos Aires los datos del estudio del CBC-UBA, que es nacional por aglomerados urbanos."),
        ("bullet", "No afirma que las plataformas incumplan sus obligaciones de seguros: afirma que no existe información pública que permita verificar su cumplimiento, y propone producirla."),
        ("bullet", "No presenta las estimaciones sindicales ni empresarias como estadística oficial."),
        ("p", "Fuentes", "report"),
